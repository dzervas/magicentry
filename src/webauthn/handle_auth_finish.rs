...
pub async fn auth_finish(session: Session, db: web::Data<reindeer::Db>, webauthn: web::Data<Webauthn>, req: Json<PublicKeyCredential>) -> Result<Json<AuthFinishResponse>> {
