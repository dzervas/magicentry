	...
	html! {
		section class="h-full bg-white dark:bg-gray-900" {
			div class="flex flex-col h-screen justify-center items-center" {
				div class="w-full py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6" {
					div class="mx-auto max-w-screen-md sm:text-center" {
						...
						form action="" method="post" {
							...
							div class="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300" {
								"Powered by "
								a href="https://github.com/dzervas/just-passwordless" class="font-medium text-primary-600 dark:text-primary-500 hover:underline" {
									"Just Passwordless"
								}
							}
						}
...
pub fn footer() -> Markup {
	html! {
		footer {
			a href="https://github.com/dzervas/just-passwordless" { "Just Passwordless" }
		}
	}
}
